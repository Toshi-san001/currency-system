...
/**
 * 
 * @param {Object} settings - Used for userID and GuildID. 
 * @param {Boolean} user2 - Wether to make user 2 instead of user 1.
 * @description This makes the user document with default settings.
 * @returns {object} - It returns the user data.
 */

async function makeUser(settings, user2) {
...
/**
 * @param {object} data - The user document which will get saved.
 */
 ...
 * @description - Find's the user using UserID and guildID.
...
/**
 * 
 * @param {String} password - MongoDB URL. 
 */
